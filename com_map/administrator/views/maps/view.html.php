...
/**
 * View class for a list of Map.
 */
class MapViewMaps extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        $canDo = MapHelper::getActions($state->get('filter.category_id'));

        JToolBarHelper::title(JText::_('COM_MAP_TITLE_MAPS'), 'maps.png');
        ...
        if ($canDo->get('core.admin')) {
            JToolBarHelper::preferences('com_map');
        }

        //Set sidebar action - New in 3.0
        JHtmlSidebar::setAction('index.php?option=com_map&view=maps');
	...
	protected function getSortFields()
	{
		...
		'a.title' => JText::_('COM_MAP_LOCATIONSS_TITLE'),
		);
	}
